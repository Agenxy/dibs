...
**Start with `lanes doctor`.** It exists for this: it names what is broken and
...
| You have | Go to |
|---|---|
| "How do I…", "should Lanes…", thinking out loud | [Discussions](https://github.com/agenxy/lanes/discussions) |
| Something behaved differently from what it said it would | [Open a bug](https://github.com/agenxy/lanes/issues/new?template=bug_report.yml) |
| Something Lanes should do and doesn't | [Open a feature request](https://github.com/agenxy/lanes/issues/new?template=feature_request.yml) |
...
- [docs/TUTORIAL.md](docs/TUTORIAL.md): fifteen minutes, from install to two
  agents catching each other duplicating work. Start here if nothing is running yet
- [README](README.md), what Lanes is, and how to install and run it
