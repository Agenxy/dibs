...
- **MCP-native**: 46 tools, self-teaching through server instructions and
...
**If you are the operator:** there is no urgency. Dibs serves both paths, all 46
...
- **Cacheable list results**: `ttlMs` and `cacheScope` on `server/discover`,
  ...
  than most servers: 46 tools whose descriptions carry real corrective detail, re-fetched on every
