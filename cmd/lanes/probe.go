...
//
// This deliberately does NOT intervene. Lanes is a service agents pull from,
...
func probe(args []string) error {
	...
	// like an explicit override and silently beat lanes.toml.
...
// settingsFor layers the operator's configuration: defaults, then lanes.toml,
