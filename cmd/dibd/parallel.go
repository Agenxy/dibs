...
//
// For this product specifically that is the worst failure available. Dibs
...
func claimHostSlot(addr, dir string, allowed bool) (func(), error) {
	...
	if err != nil {
		...
		// silently, exactly when its state could not be trusted. If Dibs cannot
		// establish that it is alone, it says so rather than assuming.
		return func() {}, fmt.Errorf(
			"cannot verify this is the only dibd on this machine: %w\n\n"+
